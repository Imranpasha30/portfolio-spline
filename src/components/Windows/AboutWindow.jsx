...
const AboutWindow = ({ id, isMinimized, onClose, onMinimize, zIndex = 40, offsetX = 180, offsetY = 120, onFocus }) => {
    ...
    const [previousSize, setPreviousSize] = useState({ width: 900, height: 650, x: 180, y: 120 });
                ...
                <div className="flex-1 overflow-auto bg-gray-900 p-8">
                    <div className="flex items-center justify-center h-full">
                        <div className="text-center">
                            ...
                            <p className="text-gray-500 text-sm mt-2">This window is ready for your about section!</p>
                        </div>
                    </div>
                </div>
            </div>
